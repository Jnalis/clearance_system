...
<div class="col-sm-6">
  <ol class="breadcrumb float-sm-right">
      ...
      <li class="breadcrumb-item active">Edit Usertype</li>
  </ol>
</div><!-- /.col -->
@endsection
    ...
    <div class="col-md-6">
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <form role="form" action="{{ route('admin.usertype.update', $user_type->id) }}" method="POST">
                    @method('put')
                    @csrf
                    <div class="result">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="usertype_name" id="usertype_name" class="form-control"
                                    placeholder="Example Head of Department" value="{{ old('usertype_name', $user_type->usertype_name) }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="usertype_code" id="usertype_code" class="form-control"
                                    placeholder="Example HOD" value="{{ old('usertype_code', $user_type->usertype_code) }}">
